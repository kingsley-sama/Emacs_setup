...
(global-set-key (kbd "C-c RET") 'xref-find-definitions)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(xref-js2 xref-rst spaceline-all-the-icons spaceline prettier stylefmt js-react-redux-yasnippets rjsx-mode lsp-python-ms pylint afternoon-theme lsp-mode yasnippet lsp-treemacs helm-lsp projectile hydra flycheck company avy which-key helm-xref dap-mode zenburn-theme json-mode)))
;; Use package:
